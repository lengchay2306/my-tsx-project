      ...
      <Tabs defaultValue="overview" className="space-y-6">
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <Card className="shadow-elegant">
              ...
              Xu hướng theo tháng</CardTitle>
              Số lượng claims và chi phí bảo hành</CardDescription>
            </CardHeader>
                ...
                <LineChart data={monthlyTrends}>
                  ...
                  <Tooltip 
                    formatter={(value, name) => {
                      if (name === 'cost') return [formatCurrency(value), 'Chi phí'];
        ...
        <TabsContent value="claims" className="space-y-6">
          <Card className="shadow-elegant">
              ...
              Phân tích Claims theo Model xe</CardTitle>
              Thống kê số lượng, chi phí và tỷ lệ hỏng hóc</CardDescription>
            </CardHeader>
        ...
        <TabsContent value="parts" className="space-y-6">
          <Card className="shadow-elegant">
              ...
              Top phụ tùng hay hỏng</CardTitle>
              Phân tích chi tiết các phụ tùng có tỷ lệ hỏng cao</CardDescription>
            </CardHeader>
        ...
        <TabsContent value="technicians" className="space-y-6">
          <Card className="shadow-elegant">
              ...
              Hiệu suất Kỹ thuật viên</CardTitle>
              Đánh giá chất lượng và hiệu quả công việc</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
        ...
        <TabsContent value="regions" className="space-y-6">
          <Card className="shadow-elegant">
              ...
              Thống kê theo khu vực</CardTitle>
              Phân tích claims và hiệu suất theo địa lý</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <ResponsiveContainer width="100%" height={300}>
