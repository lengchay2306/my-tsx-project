...
const EVMClaimReviewQueue = ({ onReviewClaim }) => {
  ...
  const getStatusBadge = (status) => {
    const statusConfig = {
      "pending-review": { variant: "warning", text: "Chờ duyệt", icon: Clock },
      "under-review": { variant: "secondary", text: "Đang duyệt", icon: Eye },
      "approved": { variant: "success", text: "Đã duyệt", icon: CheckCircle },
      "rejected": { variant: "destructive", text: "Từ chối", icon: XCircle }
    };
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between text-sm text-muted-foreground">
        ...
        <div className="flex items-center space-x-2">
          ...
          Active filters: {[statusFilter, serviceCenterFilter].filter(f => f !== "all").length}</span>
        </div>
      </div>
      ...
      <Card className="shadow-elegant">
          ...
          Claims Pending Review</CardTitle>
