            ...
            <div className="space-y-6">
              ...
              {/* Specifications Preview */}
                  ...
                  <div className="grid md:grid-cols-2 gap-4 text-sm">
                      ...
                      Model:</strong> {vehicleData.model || 'Not selected'}</p>
                      Year:</strong> {vehicleData.year || 'Not selected'}</p>
                      Color:</strong> {vehicleData.color || 'Not selected'}</p>
                    </div>
                    
                      Battery:</strong> {vehicleData.batteryCapacity || 'Not selected'}</p>
                      Motor:</strong> {vehicleData.motorType || 'Not selected'}</p>
                      Customer:</strong> {selectedCustomer?.name || 'Not linked'}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <div className="space-y-6">
              ...
              {/* Registration Summary */}
                  ...
                  <div className="grid md:grid-cols-2 gap-4 text-sm">
                      ...
                      VIN:</strong> {vehicleData.vin}</p>
                      Model:</strong> {vehicleData.model} ({vehicleData.year})</p>
                      Color:</strong> {vehicleData.color}</p>
                      Battery:</strong> {vehicleData.batteryCapacity}</p>
                    </div>
                    
                      Customer:</strong> {selectedCustomer?.name}</p>
                      Phone:</strong> {selectedCustomer?.phone}</p>
                      Purchase:</strong> {vehicleData.purchaseDate ? new Date(vehicleData.purchaseDate).toLocaleDateString('vi-VN') : 'Not set'}</p>
