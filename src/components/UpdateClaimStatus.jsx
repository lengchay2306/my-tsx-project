...
const UpdateClaimStatus = ({ claimId, currentStatus, onClose, onStatusUpdated }) => {
        ...
        <CardContent className="p-6 space-y-6">
          ...
          <div className="space-y-3">
            ...
            <Textarea
              id="notes"
              placeholder={
                newStatus === 'rejected' ? "Provide reason for rejection..."  === 'completed' ? "Describe what was completed..."  === 'cancelled' ? "Provide reason for cancellation..." :
          ...
          <div className="text-xs text-muted-foreground border-t pt-4">
            <div className="flex items-center justify-between">
              Status will be updated by: {user?.name} ({user?.role})</span>
              {user?.role === 'technician' && (
