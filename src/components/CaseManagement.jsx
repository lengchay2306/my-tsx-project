...
const CaseManagement = ({ onViewCase, onCreateCase }) => {
  ...
  const getStatusBadge = (status) => {
    const statusConfig = {
      pending: { variant: "pending", text: "Chờ duyệt" },
      approved: { variant: "approved", text: "Đã duyệt" },
      rejected: { variant: "rejected", text: "Từ chối" },
      "in-progress": { variant: "warning", text: "Đang sửa" },
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between text-sm text-muted-foreground">
        ...
        <div className="flex items-center space-x-2">
          ...
          Results filtered by: {statusFilter !== "all" ? `Status (${statusFilter})` : "All"}</span>
        </div>
      </div>
