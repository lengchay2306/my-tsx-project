...
const DiagnosticReportForm = ({ caseId, onClose, onSubmit }) => {
  ...
  const handleSubmit = (asDraft = false) => {
    ...
    toast({
      ...
      description: asDraft ? "Your diagnostic report has been saved" : "Your diagnostic report has been submitted for review",
      variant: "default"
    });
  ...
  return (
    <Dialog open={true} onOpenChange={() => onClose?.()}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          Add Diagnostic Report - {caseId}</DialogTitle>
