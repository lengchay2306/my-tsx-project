          ...
          <div className="space-y-6">
            ...
            {attachedParts.length > 0 && (
                  ...
                  <CardTitle className="flex items-center space-x-2 text-base">
                    ...
                    Attached Parts ({attachedParts.length})</span>
                  </CardTitle>
                </CardHeader>
            ...
            {selectedVehicle && attachedParts.length > 0 && (
              <Card className="bg-accent/20">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 text-sm">
                      ...
                      Vehicle:</strong> {selectedVehicle.model}</p>
                      VIN:</strong> {selectedVehicle.vin}</p>
                      Customer:</strong> {selectedVehicle.customer}</p>
                    </div>
                    
                      Parts Count:</strong> {attachedParts.length}</p>
                      Processed by:</strong> {user?.name}</p>
                      Date:</strong> {new Date().toLocaleDateString('vi-VN')}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
