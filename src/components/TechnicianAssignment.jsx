...
const TechnicianAssignment = ({ claimId, issueCategory, onAssignmentComplete, onClose }) => {
  ...
  const TechnicianCard = ({ tech, isRecommended = false }: { tech; isRecommended?: boolean }) => {
