...
const ManufacturerDashboard = () => {
  ...
  const handleClaimApproval = (claimId) => {
  ...
  const handleApprovalDecision = (decision, data) => {
  ...
  const getStatusBadge = (status) => {
    const statusConfig = {
      "pending-review": { variant: "pending", icon: Clock, text: "Chờ xem xét" },
      "in-validation": { variant: "warning", icon: AlertTriangle, text: "Đang xác thực" },
      approved: { variant: "approved", icon: CheckCircle, text: "Đã phê duyệt" },
  ...
  const getStockBadge = (urgency) => {
    const urgencyConfig = {
      critical: { variant: "destructive", text: "Khẩn cấp" },
      warning: { variant: "warning", text: "Cảnh báo" },
      normal: { variant: "success", text: "Bình thường" }
    };
        ...
        <Tabs defaultValue="claims" className="space-y-6">
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              <div className="lg:col-span-2">
                <Card className="shadow-elegant">
                    ...
                    Yêu cầu bảo hành chờ duyệt</CardTitle>
                  ...
                  <CardContent className="space-y-4">
                      ...
                      <Card key={claim.id} className="border-orange-200">
                        <CardContent className="pt-4">
                          ...
                          <div className="space-y-2 text-sm">
                            Sự cố:</strong> {claim.issueCategory}</p>
                            Trung tâm:</strong> {claim.serviceCenter}</p>
                            Ngày gửi:</strong> {new Date(claim.submittedDate).toLocaleDateString('vi-VN')}</p>
                            Chi phí ước tính:</strong> {
                    ...
                    {pendingClaims.length === 0 && (
                      <div className="text-center py-8 text-muted-foreground">
                        ...
                        Không có yêu cầu nào chờ duyệt</p>
                      </div>
                    )}
                  </CardContent>
                </Card>
                ...
                <Card className="shadow-elegant">
                    ...
                    Thống kê duyệt yêu cầu</CardTitle>
                  </CardHeader>
                  
                    <div className="space-y-4">
                      
                        <div className="flex justify-between text-sm">
                          Tỷ lệ phê duyệt</span>
              ...
              <div className="lg:col-span-2">
                <Card className="shadow-elegant">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        Parts Inventory</CardTitle>
                        Manage parts stock and supply chain</CardDescription>
                      </div>
          ...
          <TabsContent value="policies" className="space-y-6">
            <Card className="shadow-elegant">
                ...
                Warranty Policy Management</CardTitle>
                Configure warranty terms and conditions</CardDescription>
              </CardHeader>
          ...
          <TabsContent value="analytics" className="space-y-6">
            <Card className="shadow-elegant">
                ...
                Analytics & Reports</CardTitle>
                Failure analysis and predictive insights</CardDescription>
              </CardHeader>
          ...
          <TabsContent value="campaigns" className="space-y-6">
            <Card className="shadow-elegant">
                ...
                Service Campaign Management</CardTitle>
                Create and manage recall campaigns</CardDescription>
              </CardHeader>
