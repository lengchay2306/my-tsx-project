...
const KPICard = ({ title, value, change, trend, icon: Icon, isLoading }) => {
  if (isLoading) {
    return (
...
const StatusBadge = ({ status }: { status: string }) => {
  const statusConfig = {
    ...
    "in-repair": { variant: "default", text: "In Repair", className: "" },
    "awaiting-parts": { variant: "outline", text: "Awaiting Parts", className: "border-warning text-warning" },
