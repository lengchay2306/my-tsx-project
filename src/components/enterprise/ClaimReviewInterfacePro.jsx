              ...
              <div className="space-y-2">
                ...
                <div className="text-xs text-muted-foreground">
                  ...
                  <div className="flex items-center space-x-1 mt-1">
                    ...
                    Submitted {claim.dateSubmitted}</span>
                  </div>
                  <div className="flex items-center space-x-1 mt-1">
                    <FileText className="h-3 w-3" />
                    {claim.reportsCount} diagnostic reports</span>
                  </div>
                </div>
              </div>
            </div>
                ...
                {claimDetails.diagnosticReports.map((report, index) => {
                  ...
                  return (
                    <Card key={report.id} className={`border-l-4 ${
                      status === 'approved' ? 'border-l-success bg-success/5'  === 'rejected' ? 'border-l-destructive bg-destructive/5' :
                      ...
                      <CardHeader className="pb-4">
                        ...
                        By {report.technician}</CardDescription>
                      </CardHeader>
                ...
                <CardContent className="space-y-3">
                  <div className="flex items-center space-x-3">
                    <Avatar className="h-10 w-10">
                      ...
                      {claimDetails.customer.name.charAt(0)}</AvatarFallback>
                    </Avatar>
              ...
              {/* Vehicle Info */}
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="space-y-1 text-sm text-muted-foreground">
                    Purchase: {claimDetails.vehicle.purchaseDate}</div>
                    Odometer: {claimDetails.vehicle.odometer}</div>
                    Color: {claimDetails.vehicle.color}</div>
                  </div>
                </CardContent>
              </Card>
