          ...
          <div className="space-y-1">
            ...
            {change && (
              <div className={`flex items-center text-sm ${
                ...
                {trend === 'up' ? <TrendingUp className="h-3 w-3 mr-1" />  === 'down' ? <TrendingDown className="h-3 w-3 mr-1" /> : null}
                {change}
              </div>
            )}
          </div>
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <Card className="lg:col-span-2">
            ...
            <CardTitle className="flex items-center space-x-2">
              ...
              Warranty Costs Over Last 12 Months</span>
            </CardTitle>
      ...
      {/* Claims Needing Immediate Attention */}
          ...
          <CardTitle className="flex items-center space-x-2">
            ...
            Claims Needing Immediate Attention</span>
          </CardTitle>
