...
const StatusBadge = ({ status }: { status: string }) => {
  const statusConfig = {
    ...
    "in-repair": { variant: "default", text: "In Repair", className: "bg-primary text-primary-foreground" },
    "awaiting-parts": { variant: "outline", text: "Awaiting Parts", className: "border-warning text-warning bg-warning/5" },
    "awaiting-handover": { variant: "outline", text: "Awaiting Handover", className: "border-info text-info bg-info/5" },
    "manufacturer-review": { variant: "outline", text: "Manufacturer Review", className: "border-warning text-warning bg-warning/5" },
    "approved": { variant: "outline", text: "Approved", className: "border-success text-success bg-success/5" },
    "completed": { variant: "outline", text: "Completed", className: "border-success text-success bg-success/10" }
  };
        ...
        <div className="lg:col-span-3">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                    ...
                    <Card key={report.id} className="hover:shadow-md transition-shadow">
                      <CardHeader className="pb-4">
                        ...
                        <CardDescription className="flex items-center space-x-2">
                          ...
                          By {report.technician}</span>
                          {report.photos > 0 && (
                            <>
                              •</span>
                              {report.photos} photos attached</span>
                            </>
                          )}
                        </CardDescription>
                      </CardHeader>
                    ...
                    <Card key={shipment.id}>
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            ...
                            <div className="flex items-center space-x-2 text-sm text-muted-foreground mb-1">
                              ...
                              Shipped: {shipment.shippedDate}</span>
                            </div>
                            <div className="flex items-center space-x-2 text-sm text-muted-foreground">
                              <Clock className="h-4 w-4" />
                              Expected: {shipment.expectedArrival}</span>
                            </div>
                          </div>
            ...
            <TabsContent value="activity" className="space-y-4">
                  ...
                  Case Activity Timeline</CardTitle>
                  Chronological history of all case activities</CardDescription>
                </CardHeader>
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center space-x-3">
                <Avatar className="h-10 w-10">
                  ...
                  {caseData.customer.name.charAt(0)}</AvatarFallback>
                </Avatar>
          ...
          {/* Vehicle Information */}
            ...
            <CardContent className="space-y-3">
              ...
              <div className="space-y-2 text-sm text-muted-foreground">
                Purchase: {caseData.vehicle.purchaseDate}</div>
                Odometer: {caseData.vehicle.odometer}</div>
                Color: {caseData.vehicle.color}</div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center space-x-3">
                <Avatar className="h-10 w-10">
                  ...
                  {caseData.assignedTech.name.charAt(0)}</AvatarFallback>
                </Avatar>
                <div className="flex-1 min-w-0">
