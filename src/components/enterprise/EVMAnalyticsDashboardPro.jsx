    ...
    <div className="space-y-8 p-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        {/* Warranty Costs Over Time */}
            ...
            Warranty Costs Over Last 12 Months</CardTitle>
            Monthly warranty claim costs in USD</CardDescription>
          </CardHeader>
        ...
        {/* Claims by Status */}
            ...
            Claims by Status</CardTitle>
            Current distribution of warranty claims</CardDescription>
          </CardHeader>
      ...
      {/* Top Failing Components Chart */}
          ...
          Top 5 Failing Components</CardTitle>
          Components with the highest failure counts</CardDescription>
        </CardHeader>
      ...
      {/* Critical Failure Rate Statistics */}
          ...
          <div className="flex items-center justify-between">
              ...
              Core data for business decisions and quality analysis</CardDescription>
            </div>
