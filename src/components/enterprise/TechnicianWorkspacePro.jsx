...
const StatusBadge = ({ status }: { status: string }) => {
  const statusConfig = {
    "new": { variant: "outline", text: "New Assignment", className: "border-info text-info bg-info/5" },
    "in-progress": { variant: "default", text: "In Progress", className: "bg-primary text-primary-foreground" },
    "awaiting-parts": { variant: "outline", text: "Awaiting Parts", className: "border-warning text-warning bg-warning/5" },
    "ready-check": { variant: "outline", text: "Ready for Final Check", className: "border-success text-success bg-success/5" }
  };
...
const TechnicianWorkspacePro = () => {
  ...
  const handleMarkComplete = () => {
    if (selectedCase) {
      // Handle marking work
      console.log("Marking technical work for:", selectedCase);
    }
  };
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-1">
              ...
              Cases assigned to you</CardDescription>
            </CardHeader>
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <Dialog open={isDiagnosticDialogOpen} onOpenChange={setIsDiagnosticDialogOpen}>
                  ...
                  <DialogContent className="max-w-2xl">
                      ...
                      Add Diagnostic Report</DialogTitle>
                    </DialogHeader>
                    <div className="space-y-6">
                ...
                <Dialog open={isProgressDialogOpen} onOpenChange={setIsProgressDialogOpen}>
                  <DialogTrigger asChild>
                    <Button variant="outline" size="lg" className="h-16">
                      ...
                      Log Progress / Record Installation</DialogTitle>
                    </DialogHeader>
                    <div className="space-y-6">
                    ...
                    <div className="mt-4 p-3 bg-warning/10 border border-warning/20 rounded-lg">
                      <div className="flex items-center space-x-2">
                        ...
                        <p className="text-sm text-warning-foreground">
                          Complete all repair work before marking
                        </p>
                      </div>
                    </div>
                  )}
