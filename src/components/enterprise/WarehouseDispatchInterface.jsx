...
const WarehouseDispatchInterface = () => {
  const [selectedOrder, setSelectedOrder] = useState("DO-2025-001");
  ...
  const getStatusBadge = (status) => {
    const statusConfig = {
      ...
      "in-progress": { variant: "default", text: "In Progress", icon: Package },
      "ready-ship": { variant: "success", text: "Ready to Ship", icon: Truck },
          ...
          <div className="p-6 space-y-6">
            ...
            {/* Destination Information */}
                ...
                <CardTitle className="flex items-center space-x-2">
                  ...
                  Destination Service Center</span>
                </CardTitle>
              </CardHeader>
            ...
            {/* Items Processing */}
                ...
                <CardTitle className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    Items to Ship ({selectedOrderData.items.length})</span>
                  </div>
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <div className="flex items-center space-x-2">
                                ...
                                <Badge variant={
                                  completionStatus === "complete" ? "success"  === "partial" ? "warning" : "secondary"
                                }>
                                  {completionStatus === "complete" ? "Ready"  === "partial" ? "Partial" : "Pending"}
                                </Badge>
                              </div>
                            </div>
          ...
          {selectedOrderData && (
            <div className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                  ...
                  {selectedOrderData.serviceCenter.name}</p>
                </div>
              </div>
